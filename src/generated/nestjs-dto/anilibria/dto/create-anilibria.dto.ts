...
import {ConnectAnilibriaTypeDto} from '../../anilibriaType/dto/connect-anilibriaType.dto'
import {ConnectAnilibriaNameDto} from '../../anilibriaName/dto/connect-anilibriaName.dto'
import {ConnectAnilibriaSeasonDto} from '../../anilibriaSeason/dto/connect-anilibriaSeason.dto'
import {ConnectAnilibriaPosterDto} from '../../anilibriaPoster/dto/connect-anilibriaPoster.dto'
import {ConnectAnilibriaAgeRatingDto} from '../../anilibriaAgeRating/dto/connect-anilibriaAgeRating.dto'
import {ConnectAnilibriaSponsorDto} from '../../anilibriaSponsor/dto/connect-anilibriaSponsor.dto'
import {ConnectAnilibriaPublishDayDto} from '../../anilibriaPublishDay/dto/connect-anilibriaPublishDay.dto'
import {CreateAnilibriaGenreEdgeDto} from '../../anilibriaGenreEdge/dto/create-anilibriaGenreEdge.dto'
import {ConnectAnilibriaGenreEdgeDto} from '../../anilibriaGenreEdge/dto/connect-anilibriaGenreEdge.dto'
import {CreateAnilibriaEpisodeDto} from '../../anilibriaEpisode/dto/create-anilibriaEpisode.dto'
import {ConnectAnilibriaEpisodeDto} from '../../anilibriaEpisode/dto/connect-anilibriaEpisode.dto'
import {CreateAnilibriaTorrentDto} from '../../anilibriaTorrent/dto/create-anilibriaTorrent.dto'
